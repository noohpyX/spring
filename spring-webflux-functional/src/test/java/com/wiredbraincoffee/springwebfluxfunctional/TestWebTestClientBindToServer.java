...
/**
 * Class that shows how to bind a WebTestClient instance to a server
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class TestWebTestClientBindToServer {
     ...
     * Here we are binding the WebTestClient instance to a server and also getting all the data in the database
