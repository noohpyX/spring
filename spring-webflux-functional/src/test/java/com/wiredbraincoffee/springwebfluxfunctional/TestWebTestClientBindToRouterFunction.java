...
/**
 * Class that shows how to bind a WebTestClient instance to a router function
 */
@SpringBootTest
class TestWebTestClientBindToRouterFunction {
     ...
     * Here we are binding the WebTestClient instance to a router function and also getting all the data in the database
